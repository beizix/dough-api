package io.dough.api.useCases.user.mgmt.removeManager.adapters.web;

import io.dough.api.useCases.user.mgmt.removeManager.adapters.web.model.RemoveManagerRequest;
import io.dough.api.useCases.user.mgmt.removeManager.adapters.web.model.RemoveManagerResponse;
import io.dough.api.useCases.user.mgmt.removeManager.application.RemoveManagerUseCase;
