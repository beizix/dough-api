package io.dough.api.useCases.user.maintenance.getUser.adapters.web;

import io.dough.api.useCases.user.maintenance.getUser.adapters.web.model.GetUserResponse;
import io.dough.api.useCases.user.maintenance.getUser.application.GetUserUseCase;
...
public class GetUserDetailWebAdapter {
  ...
  public GetUserResponse getUser(
    ...
    return GetUserResponse.from(getUserUseCase.operate(new GetUserCmd(id)));
  }
}
