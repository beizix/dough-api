package io.dough.api.useCases.user.mgmt.removeManager.adapters.persistence;
...
import io.dough.api.useCases.user.mgmt.removeManager.application.DeleteManager;
