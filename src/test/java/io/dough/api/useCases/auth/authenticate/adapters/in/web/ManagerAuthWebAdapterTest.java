...
@WebMvcTest(ManagerAuthWebAdapter.class)
class ManagerAuthWebAdapterTest extends WebMvcTestBase {

  @MockitoBean private AuthenticateUseCase authenticateUseCase;

  @Test
  @DisplayName("Scenario: 성공 - 유효한 이메일/비번으로 매니저 로그인 요청 시 토큰이 반환된다")
  void login_manager_success() throws Exception {
    // Given
    AuthenticateRequest req = new AuthenticateRequest("admin@dough.io", "admin123");
