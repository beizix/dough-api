...
@Import(LogoutPersistAdapter.class)
class LogoutPersistAdapterTest extends DataJpaTestBase {

  @Autowired private LogoutPersistAdapter logoutPersistAdapter;
  ...
  void logout_persistence_success() {
    ...
    // When
    logoutPersistAdapter.operate(userId);
